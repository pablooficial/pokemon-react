import { ComponentImgPokemon, ComponentWraper, ComponentWraperImg, ComponentTitle, ComponentWraperAtributs, ComponentAtributs, ComponentType, ComponentWraperType, ComponentTitleFloating, ComponentWraperAbilits, ComponentWraperItens, ComponentPokeball, ComponentWraperStatistics, ComponentEditTitle, ComponentWraperButton, ComponentClosed } from "./styled";
...
import { alterName, getLocalStorage, removerLocalStorage, verifyLocalStorage } from "../../ultils/localStorage";
...
const Card = ({ onclick }: Props) => {
    ...
    return (
        ...
        <ComponentWraper className={modal.open ? 'open' : ''}>
            <ComponentClosed onClick={closeModal}><img src={cancelar} alt="closed"></img></ComponentClosed>
            <ComponentWraperItens>
                <ComponentWraperImg>
                    <ComponentImgPokemon src={test?.data?.sprites?.other?.home?.front_default}></ComponentImgPokemon>
                </ComponentWraperImg>
                {
                    showEdit ? (
                        <ComponentEditTitle>
                            ...
                            <ComponentWraperButton>
                                <button><img src={confirme} alt="confirm" className="confirm" onClick={confirmEdit} /></button>
                                <button><img src={cancelar} alt="cancel" className="close" onClick={closedEdit} /></button>
                            </ComponentWraperButton>
                        </ComponentEditTitle>
                    ) : (
                        <>
                ...
                <ComponentWraperAtributs>
                    <ComponentAtributs>
                        <h2>HP</h2>
                        <p>{test?.data?.stats ? test?.data?.stats[0]?.base_stat : ''}</p>
                    </ComponentAtributs>
                    <ComponentAtributs className="mid">
                        <h2>Altura</h2>
                        <p>{test?.data?.height} m</p>
                    </ComponentAtributs>
                    <ComponentAtributs>
                        <h2>peso</h2>
                        <p>{test?.data?.weight} Kg</p>
                    </ComponentAtributs>
                </ComponentWraperAtributs>
                ...
                <ComponentWraperAbilits className="end">
                    ...
                    <p>{test?.data?.abilities ? test?.data?.abilities[0]?.ability.name : ''}, {test?.data?.abilities ? test?.data?.abilities[1]?.ability.name : ''}</p>
                    ...
                    modal?.edit ? (
                        <ComponentWraperAbilits className="end">
                            ...
                            <ComponentWraperStatistics>
                                ...
                                <p>{test?.data.stats?.[2]?.base_stat}</p>
                            </ComponentWraperStatistics>
                            ...
                            <ComponentWraperStatistics>
                                ...
                                <p>{test?.data.stats?.[1]?.base_stat}</p>
                            </ComponentWraperStatistics>
                            ...
                            <ComponentWraperStatistics>
                                ...
                                <p>{test?.data.stats?.[3]?.base_stat}</p>
                            </ComponentWraperStatistics>
                            ...
                            <ComponentWraperStatistics>
                                ...
                                <p>{test?.data.stats?.[4]?.base_stat}</p>
                            </ComponentWraperStatistics>
                        </ComponentWraperAbilits>
                    ) : (
                        ''
...

        {
            modal?.open ? (
                <>
                {
                    modal?.edit ? (<Button botton='83px' onclick={remover}>LIBERAR POKEMON</Button>) : (<ComponentPokeball src={pokebola} alt="pokeball" onClick={captur} />)
                }
                </>
            ): ('')
        }
